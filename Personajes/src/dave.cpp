...
bool dave::lanzarHechizoCurar(pieza* objetivoaliado) {
...
bool dave::lanzarHechizoResucitar(pieza* objetivomuerto) {
...
// (La lógica del teletransporte implicaría que tu compañero mueva el puntero 
// en su matriz tablero usando las coordenadas nuevafila y nuevacolumna).